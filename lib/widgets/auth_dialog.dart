...
import 'package:prueba_mvc/widgets/google_sign_in_button.dart';
                ...
                Center(child:InkWell(
                    ...
                    onTap: () {
                      if (_validateEmail(textControllerEmail.text) == null){
                        setState(() {
                          loginStatus = 'Enviando correo';
                          loginStringColor = Colors.green;
                        });
                        forgoutPassword(textControllerEmail.text);
